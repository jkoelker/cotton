...
func (o *TransactionAPIOptionDeliverable) GetDeliverable() TransactionInstrument {
	if o == nil || IsNil(o.Deliverable) {
		var ret TransactionInstrument
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TransactionAPIOptionDeliverable) GetDeliverableOk() (*TransactionInstrument, bool) {
	if o == nil || IsNil(o.Deliverable) {
		return nil, false
	}
...
func (o *TransactionAPIOptionDeliverable) SetDeliverable(v TransactionInstrument) {
	o.Deliverable = &v
}

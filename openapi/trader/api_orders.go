...
func (a *OrdersAPIService) GetOrdersByPathParamExecute(r ApiGetOrdersByPathParamRequest) ([]Order, *http.Response, error) {
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "fromEnteredTime", r.fromEnteredTime, "")
	parameterAddToHeaderOrQuery(localVarQueryParams, "toEnteredTime", r.toEnteredTime, "")
	if r.status != nil {

...
func (a *PriceHistoryAPIService) GetPriceHistoryExecute(r ApiGetPriceHistoryRequest) (*CandleList, *http.Response, error) {
	...
	if r.frequencyType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "frequencyType", r.frequencyType, "")
	}
	if r.frequency != nil {
	...
	if r.needExtendedHoursData != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "needExtendedHoursData", r.needExtendedHoursData, "")
	}
	if r.needPreviousClose != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "needPreviousClose", r.needPreviousClose, "")
	}

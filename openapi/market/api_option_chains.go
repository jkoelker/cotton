...
func (a *OptionChainsAPIService) GetChainExecute(r ApiGetChainRequest) (*OptionChain, *http.Response, error) {
	...
	if r.strikeCount != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "strikeCount", r.strikeCount, "")
	}
	if r.includeUnderlyingQuote != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeUnderlyingQuote", r.includeUnderlyingQuote, "")
	}
	if r.strategy != nil {
	...
	if r.volatility != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "volatility", r.volatility, "")
	}
	if r.underlyingPrice != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "underlyingPrice", r.underlyingPrice, "")
	}
	...
	if r.daysToExpiration != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "daysToExpiration", r.daysToExpiration, "")
	}
	if r.expMonth != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "expMonth", r.expMonth, "")
	}
	if r.optionType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "optionType", r.optionType, "")
	}
